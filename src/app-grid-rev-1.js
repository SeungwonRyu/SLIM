...
function init() {
    ...
    var theGrid = new wjGrid.FlexGrid('#grid-rev-1', {
        ...
        columns: [
            ...
            { binding: 'bidSize', header: 'Bid Size', format: 'n0', width: 110 },
            { binding: 'askSize', header: 'Ask Size', format: 'n0', width: 110 },
            { binding: 'lastSize', header: 'Last Size', format: 'n0', width: 110 },
